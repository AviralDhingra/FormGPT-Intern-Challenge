...
function Create() {
  ...
  const handleSubmit = (event) => {
    ...
    post("/createForm", {
      ...
      goal: x.goal.value,
      logo: x.logo.value,
      questions: x.questions.value,
      initialPrompting: x.initialPrompting.value,
      summaryPrompting: x.summaryPrompting.value,
      nps: x.nps.checked,
      redirect: x.redirect.value || "https://www.google.com/",
      user_id: userId,
      table: x.table.value,
  ...
  const copy = () => {
    navigator.clipboard.writeText(
      "https://formgptfrontend.vercel.app/form/" + redirect
    );
  };
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
        ...
        <main className="mx-6 sm:mx-8 lg:mx-10 my-14 sm:my-9 lg:my-14 rounded-md bg-white drop-shadow-md">
          <div className="m-6">
            {/* Page header */}
            <div className="sm:flex sm:justify-between sm:items-center mb-8">
              {/* Left: Title */}
              <div className="mb-4 sm:mb-0 w-full text-center">
                  ...
                  <div className="text-sm mb-10">
                    <div className="space-y-2">
                      <p>
                        ...
                        <a
                          href={
                            "https://formgptfrontend.vercel.app/form/" +
                            redirect
                          }
                          target="_blank"
